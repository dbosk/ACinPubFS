...
We summarize this algorithm in the following definition.

\begin{definition}[Split group]\label{SplitGroup}
  \dots
\end{definition}
...
\begin{theorem}
  The algorithm in \cref{SplitGroup} is X-IND-CCA provided the encryption 
  algorithm is IND-CCA secure and the signature scheme is strongly one-time 
  unforgeable.
\end{theorem}
