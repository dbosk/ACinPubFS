...
The protocol for the pull model achieves strong privacy properties.
...
get any security in the push protocol.
Hence the security guarantees are much weaker: for the push protocol the 
adversary can only control a small part of the storage system, or monitor only 
part of the network.
...
property.
Any subscriber could publish to all subscribers in the pull protocol.
