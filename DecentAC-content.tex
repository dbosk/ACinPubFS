...
The motivation behind these two constructions is that one is optimized for 
Alice and the other for Alice's friends.
...
many Tor~\cite{Tor} circuits to transfer a little data and establishing one 
circuit while transferring more data.
