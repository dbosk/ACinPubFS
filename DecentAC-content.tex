...
However, after a few published messages she has learned (by timing-attacks and 
own publications) who has which inbox, thus she can easily win the ANO-IND-CCA 
game (\cref{ANO-IND-CCA}).
