...
\NewDocumentCommand{\C}{o o o o}{\ensuremath{%
    \Cop%
    \IfValueT{#1}{%
      _{#1}%
    }%
...
\NewDocumentCommand{\cpub}{o m o}{\ensuremath{%
    \C[#1][#2][publish]%
    \IfValueT{#3}{%
      \mleft( \IfValueTF{#3}{#3}{\cdot} \mright)%
    }
  }}
...
\NewDocumentCommand{\csplit}{o m o}{\ensuremath{%
    \IfValueTF{#3}{%
      \C[#1][#2][split][#3]%
    }{%
      \C[#1][#2][split]%
