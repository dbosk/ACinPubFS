...
reference monitor as opposed to the traditional way of having \iac{TTP}.
...
% XXX Improve SystemModel intro paragraph
...
nodes, are anonymous.
% XXX We should be able to formalize this
...
% XXX Add reference to NebuloStore
...
% XXX Formalize the security analysis for the Pull Model scheme
...
% XXX Integrate our contributions to the related work
