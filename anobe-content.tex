...
% XXX Summarize the complexities in a table
...
\begin{table}
  ...
  \caption{%
    ...
    \(F\) is the set of friends of a user, \(S\) is the set of recipients of 
    a message.
  }\label{tab:PublisherComplexities}
  }
  \subfloat{%
  \begin{tabular}{lrr}
    Publisher
