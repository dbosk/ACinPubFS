...
% XXX Finish performance in the contributions part
...
We assume that Alice and Bob previously has securely exchanged public keys and 
...
The object \(o_m\) can be on any storage node in the system, Alice simply 
generates a random object name that does not already exist.
...
% XXX Write the performance evaluation
